...
!  Constant zonal wind stress 0.1 N/m2 (kinematic 9.76e-5 m2/s2), tanh
!  ramp over first ~12 h: drives a SUSTAINED wind-forced current over the
!  seamount -> sigma-PGE test under real external forcing (truth /= 0).
!  Gated by SEAMOUNT_WIND so a no-wind (rest) build is possible.
# ifdef SEAMOUNT_WIND
      val1=9.76E-05_r8*0.5_r8*(1.0_r8+TANH((time(ng)-43200.0_r8)/        &
     &                                     21600.0_r8))
# else
      val1=0.0_r8
# endif
      DO j=JstrT,JendT
        DO i=IstrP,IendT
          sustr(i,j)=val1*0.70710678_r8   ! E55: 45 deg
# ifdef TL_IOMS
          tl_sustr(i,j)=val1*0.70710678_r8
# endif
        END DO
      END DO
...
# endif
      ...
      END IF
#elif defined SEAMOUNT
!  E52 rotated forcing: same tanh-ramped 0.1 N/m2 stress, now MERIDIONAL.
# ifdef SEAMOUNT_WIND
      val1=9.76E-05_r8*0.5_r8*(1.0_r8+TANH((time(ng)-43200.0_r8)/        &
     &                                     21600.0_r8))
# else
...
# endif
      DO j=JstrP,JendT
        DO i=IstrT,IendT
          svstr(i,j)=val1*0.70710678_r8
# ifdef TL_IOMS
          tl_svstr(i,j)=val1*0.70710678_r8
# endif
        END DO
      END DO
#else
